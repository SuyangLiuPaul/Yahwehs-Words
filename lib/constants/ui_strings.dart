...
const uiStrings = {
  ...
  // its `.arb` files, because the three apps now render notes the same
  // way and a reader who uses more than one should meet the same words.
  'notesShowAll': {
    'zh-Hans': '展开全部译者注',
    'zh-Hant': '展開全部譯者註',
    'en': 'Show all notes',
  ...
  'chronologyMotherAge': {
    'en': 'Mother of {name} (aged {n} at the birth)',
    'zh-Hans': '{name}之母（生子时 {n} 岁）',
    'zh-Hant': '{name}之母（生子時 {n} 歲）',
  },
