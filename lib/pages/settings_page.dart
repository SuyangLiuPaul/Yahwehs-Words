...
class _ProjectorCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // rule the projection page applies where it reads it.
    final ground = ProjectionGround.values.firstWhere(
      (g) => g.name == settings.projectionGround,
              ...
              DropdownButton<ProjectionGround>(
                ...
                items: [
                  for (final g in ProjectionGround.values)
                    DropdownMenuItem(
                      value: g,
                      child: Text(projectionGroundLabel(g, locale),
                          style: label()),
                    ),
                ],
              ),
